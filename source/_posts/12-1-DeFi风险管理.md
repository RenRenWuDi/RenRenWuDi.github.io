...
tags:
  - DeFi进阶
description: 清算线、LTV、滑点、gas费——DeFi借贷最核心的参数解读与风控策略
cover: false
---
## DeFi风险管理
...
✅ LTV是DeFi生命线，抵押率决定你的安全边际

✅ 清算不是小概率事件，波动市况下随时可能发生

✅ 滑点是隐形税，大额交易前先检查池子深度

✅ Gas费是时间成本，学会择时操作可以省下大笔费用

✅ 仓位管理是复利的基础——先学会不亏钱，再想怎么赚钱
